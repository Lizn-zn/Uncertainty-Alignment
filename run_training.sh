...
# exp No.2
CUDA_VISIBLE_DEVICES=7 python train_model.py --dataset cifar10 --dataset_size 1.0 --model vgg8 --trial 1
CUDA_VISIBLE_DEVICES=7 python train_model.py --dataset stl10 --dataset_size 1.0 --model resnet56 --epochs 600 --weight_decay 5e-4 --trial 1
